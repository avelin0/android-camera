package com.eyllo.vista.cameraGoogle;
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    if (BuildConfig.DEBUG) {
                        ...
                        Crashlytics.getInstance().core.log(Log.ERROR, TAG, "Frame processing thread interrupted on release.");
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    if (BuildConfig.DEBUG) {
                        Log.e(TAG, "Failed to clear camera preview.");
                    } else {
                        Crashlytics.getInstance().core.log(Log.ERROR, TAG, "Failed to clear camera preview.");
                        Crashlytics.getInstance().core.logException(e);
                    }
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(mFocusMode)) {
                ...
                if(BuildConfig.DEBUG) {
                    ...
                    Crashlytics.getInstance().core.log(Log.INFO, TAG, "Camera focus mode: " + mFocusMode + " is not supported on this device.");
                }
            }
        }
            ...
            if (parameters.getSupportedFlashModes() != null) {
                if (parameters.getSupportedFlashModes().contains(mFlashMode)) {
                    ...
                    if(BuildConfig.DEBUG) {
                        ...
                        Crashlytics.getInstance().core.log(Log.INFO, TAG, "Camera flash mode: " + mFlashMode + " is not supported on this device.");
                    }
...
//            maybe %360 don't need in ocr, because it isn't writenned in ocr code from google
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            if (BuildConfig.DEBUG) {
                                Log.e(TAG, "Frame processing loop terminated.");
                            } else {
                                Crashlytics.getInstance().core.log(Log.ERROR, TAG, "Frame processing loop terminated.");
                                Crashlytics.getInstance().core.logException(e);
                            }
                            return;
                        }
                ...
                try {
                    ...
                    if (BuildConfig.DEBUG) {
                        Log.e(TAG, "Exception thrown from receiver.");
                    } else {
                        Crashlytics.getInstance().core.log(Log.ERROR, TAG, "Exception thrown from receiver.");
